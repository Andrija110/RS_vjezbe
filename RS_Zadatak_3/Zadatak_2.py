...
print(kvadriranje_duljine) # Ispis: [49, 36, 36, 49]
#%%
# 2. Koristeći funkciju filter, filtrirajte samo brojeve koji su veći od 5:
brojevi = [1, 21, 33, 45, 2, 2, 1, -32, 9, 10]

veći_od_5 = list(filter(lambda x: x > 5, brojevi))

print(veći_od_5) # Ispis: [21, 33, 45, 9, 10]
#%%
...
print(svi_punoljetni) # Ispis: False
#%%
